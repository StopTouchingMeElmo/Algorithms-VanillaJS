...
function Animal(name, voice) { // конструктор
  this.name = name;
  this.voice = voice;
}
...
class AnimalClass {
  constructor(name, voice) { // конструктор
    this.name = name;
    this.voice = voice;
  }
  say() {
...
// Ключевое слово super дает доступ ни только к супер конструктору, но и к любому методу в супер классе.
